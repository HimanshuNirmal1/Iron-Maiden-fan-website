...
function addItemToCart(title, price, imgSrc){
    ...
    for(var i = 0; i < cartItemsNames.length; i++){
        if(cartItemsNames[i].innerText == title){
            ...
            return //exit function and stop execution of the lines below
        }
    }
    var cartRowContents = `
...
function updateCartTotal(){
    ...
    var total = 0
    //console.log("hihihihihi",cartRows[0].getElementsByClassName("cart-quantity-input").value)
    for(var i=0; i<cartRows.length; i++){
      ...
      // console.log(priceElement, quantityElement)
       ...
       var price = parseFloat(priceElement.innerText.replace('$', '')) //converts str to float
